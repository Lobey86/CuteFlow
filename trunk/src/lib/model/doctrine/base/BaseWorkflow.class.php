...
abstract class BaseWorkflow extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('sender_id', 'integer', 4, array('type' => 'integer', 'length' => 4));
        $this->hasColumn('end_action', 'integer', 4, array('type' => 'integer', 'length' => 4));
        $this->hasColumn('template_id', 'integer', 4, array('type' => 'integer', 'length' => 4));
        ...
        $this->hasColumn('archived_at', 'timestamp', null, array('type' => 'timestamp'));
    }
