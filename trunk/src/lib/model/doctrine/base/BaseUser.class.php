...
abstract class BaseUser extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('access_level', 'integer', 4, array('type' => 'integer', 'length' => '4'));
        ...
        $this->hasColumn('telephone1', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('telephone2', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('mobilephone', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('fax', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('organisation', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('department', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('cost_center', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('userdefined1', 'string', 255, array('type' => 'string', 'length' => '255'));
        $this->hasColumn('userdefined2', 'string', 255, array('type' => 'string', 'length' => '255'));
