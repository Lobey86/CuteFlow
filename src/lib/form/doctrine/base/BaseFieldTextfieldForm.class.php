...
/**
 * FieldTextfield form base class.
 *
 * @method FieldTextfield getObject() Returns the current form's model object
 *
 * @package    cf
 * @subpackage form
 ...
 */
abstract class BaseFieldTextfieldForm extends BaseFormDoctrine
{
