...
abstract class BaseWorkflowProcessUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'inprogresssince'       => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'decissionstate'        => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'dateofdecission'       => new sfValidatorString(array('max_length' => 50, 'required' => false)),
