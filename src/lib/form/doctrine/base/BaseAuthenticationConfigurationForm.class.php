...
abstract class BaseAuthenticationConfigurationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ldaphost'                   => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapdomain'                 => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapbindusernameandcontext' => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldappassword'               => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldaprootcontext'            => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapusersearchattribute'    => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapfirstname'              => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldaplastname'               => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapusername'               => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapemail'                  => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapoffice'                 => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapphone'                  => new sfValidatorString(array('max_length' => 100, 'required' => false)),
      'ldapcontext'                => new sfValidatorString(array('max_length' => 100, 'required' => false)),
