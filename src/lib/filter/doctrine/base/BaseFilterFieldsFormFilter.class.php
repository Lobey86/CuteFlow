...
/**
 * FilterFields filter form base class.
 *
 * @package    cf
 * @subpackage filter
 ...
 */
abstract class BaseFilterFieldsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('filter_fields_filters[%s]');
