...
/**
 * WorkflowSlotFieldNumber filter form base class.
 *
 * @package    cf
 * @subpackage filter
 ...
 */
abstract class BaseWorkflowSlotFieldNumberFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('workflow_slot_field_number_filters[%s]');
