        ...
        <table width="823">
            ...
            <?php
                ...
                foreach ($workflow as $wf) {
                    ...
                    echo '<td style="background-color:'.$colorFlag.'"><a href="'.url_for('layout/linklogin',true).'/versionid/'.$wf['workflowversion_id'].'/workflowid/'.$wf['workflow_id'].'/userid/'.$userid.'" target="_blank">'.$linkto.'</a></td>';
                    echo '</tr>';
                }
