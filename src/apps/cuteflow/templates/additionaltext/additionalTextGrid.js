...
cf.additionalTextGrid = function(){return {
	...
	initCM: function () {
		this.theTextCM  =  new Ext.grid.ColumnModel([
			...
			{header: "<div ext:qtip=\"<table><tr><td><img src='/images/icons/script_code_red.png' />&nbsp;&nbsp;</td><td><?php echo __('Copy Text',null,'additionaltext'); ?></td></tr><tr><td><img src='/images/icons/script_edit.png' />&nbsp;&nbsp;</td><td><?php echo __('Edit Text',null,'additionaltext'); ?></td></tr><tr><td><img src='/images/icons/script_delete.png' />&nbsp;&nbsp;</td><td><?php echo __('Remove Text',null,'additionaltext'); ?></td></tr></table>\" ext:qwidth=\"200\"><?php echo __('Action',null,'usermanagementpopup'); ?></div>", width: 80, sortable: true, dataIndex: 'id', css : "text-align : left;font-size:12px;align:center;", renderer: cf.additionalTextGrid.renderButtons }
		]);
	},
